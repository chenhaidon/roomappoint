            ...
            <div class="auth-right">
                <div class="auth-form-wrap">
                    <div class="auth-form-header auth-form-item--enter" style="--delay: 0ms">
                        ...
                        <p class="auth-subtitle">开始高效学习之旅</p>
                    </div>

                    <el-form class="auth-form" ref="registerForm" :model="formData" label-position="top" :rules="rules">
                        ...
                        <el-form-item label="密码" prop="Password" class="auth-form-item--enter" style="--delay: 140ms">
                        ...
                        <el-form-item label="姓名" prop="Name" class="auth-form-item--enter" style="--delay: 200ms">
                            <el-input v-model.trim="formData.Name" placeholder="请输入姓名"
                                prefix-icon="el-icon-user-solid" size="large"></el-input>
                        </el-form-item>

                        <el-form-item label="邮箱" prop="Email" class="auth-form-item--enter" style="--delay: 260ms">
                            <el-input v-model.trim="formData.Email" placeholder="请输入邮箱"
                                prefix-icon="el-icon-message" size="large"></el-input>
                        </el-form-item>

                        <el-form-item label="手机号码" prop="PhoneNumber" class="auth-form-item--enter" style="--delay: 320ms">
                            <el-input v-model.trim="formData.PhoneNumber" placeholder="请输入手机号码"
                        ...
                        <el-form-item class="auth-form-item--enter" style="--delay: 440ms">
                            <el-button class="auth-btn auth-btn--primary" :class="{ 'is-loading': isLoading }" type="primary" size="large" @click="RegisterBtn">
                                {{ isLoading ? '注册中' : '立即注册' }}
                            </el-button>
                        </el-form-item>
                    </el-form>
